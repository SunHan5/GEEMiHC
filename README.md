...
Maintainer: Han Sun <sunh529@mails.ccnu.edu.cn>

Imports: phyloseq, cluster, compositions, permute, PGEE, vegan, ape, aSPU, MiSPU, devtools 

Description: GEEMiHC detects sparse microbial association signals between microbiome and a host phenotype from longitudinal  microbiome data. As a special case of longitudinal data, cross-sectional microbiome data can be also applied.
...
URL: https://github.com/SunHan5/GEEMiHC

## Introduction

`GEEMiHC` detects sparse microbial association signals between microbiome and a host phenotype from longitudinal microbiome data. As a special case of longitudinal data, cross-sectional microbiome data can be also applied.
...
## References
* Koh, H. and Zhao, N. (2020) A powerful microbial group association test based on the higher criticism analysis for sparse microbial association signals. _Microbiome_ 8(1):63.

* Vázquez-Baeza, Y. et al. (2018) Guiding longitudinal sampling in IBD cohorts. _Gut_ 67:1743-1745.
...
### Usage
```
SimulateOTU(data, nSam, nOTU, n_repeat, mu, size)
```
...
* Wu, C. et al. (2016) An adaptive association test for microbiome data. _Genome Med_ 8:56.


## Statement

Our code mainly refers to R packages, _MiHC_ and _MiSPU_.
